...
local commandHelp = {
	id = "binocular",
	command = "U",
	icon = "https://i.ibb.co/ZfWzKFj/icons8-binoculars-48px.png",
	text = "Utiliser les jumelles"
}

local binocularKey = Keys[commandHelp.command]
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if DataPlayer and DataPlayer.Inventaire and has_value(DataPlayer.Inventaire, "id", 2021) then
            ...
            if IsControlJustReleased(1, binocularKey) then
                binoculars = true
                ...
                while binoculars and not IsEntityDead(lPed) and (GetVehiclePedIsIn(lPed) == vehicle) and true do
                    if IsControlJustReleased(1, binocularKey) then -- Toggle binoculars
