...
AddEventHandler('anim:cuff', function(isPolice, from)
    ...
    if cuffed then
        defaultNotification.message = "Vous êtes libre."
    ...
    -- If the player wasn't cuffed before, we want to cuff them now.
        ...
        defaultNotification.message="Vous êtes menotté."
...
Citizen.CreateThread(function()
    while true do
        ...
        if cuffed then
            ...
            DisableControlAction(0, 22, true) -- INPUT_SPRINT
            DisableControlAction(0, 289, true) -- INPUT_SPRINT
