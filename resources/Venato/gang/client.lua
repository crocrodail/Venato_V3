...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)        
        if IsControlJustPressed(1, 56) and GetLastInputMethod(2) and platypus.HasJob(8) then -- press action contextuel (e) pour joueur clavier uniquement
