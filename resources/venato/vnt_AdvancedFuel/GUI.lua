...
function MenuGas.Bool(option, bool, cb)
	MenuGas.Option(option)
...
function MenuGas.Int(option, int, min, max, cb)
	MenuGas.Option(option);
...
function MenuGas.StringArray(option, array, position, cb)
...
function MenuGas.updateSelection()
	selectPressed = false;
	leftPressed = false;
	rightPressed = false;
...
AddEventHandler("GUI:Int", function(option, int, min, max, cb)
	MenuGas.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)
...
AddEventHandler("GUI:StringArray", function(option, array, position, cb)
	MenuGas.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)
